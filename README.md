...
|-----------|------|--------|--------|-------|
| **helix** | [rdmilly/helix](https://github.com/rdmilly/helix) | VPS1 | ✅ live | Core AI platform — expand to include helix-mcp, The Forge, MemBrain, transcript-bridge |
...
| **mcp-servers** | rdmilly/mcp-servers (needs repo) | VPS2 | 🔄 next | All MCP integration servers monorepo |
| **git-agent** | [rdmilly/git-agent](https://github.com/rdmilly/git-agent) | VPS1 | ✅ live | AI commit pipeline, ghcr.io image |
| **hostinger-watchdog** | rdmilly/hostinger-watchdog (needs repo) | VPS1+VPS2 | 🔄 next | VPS health safety daemon |
...
| **adventures-of-shanghai** | rdmilly/adventures-of-shanghai (needs repo) | VPS2 | 🔄 next | Investigative content brand |
...
| **mw-voice** | rdmilly/mw-voice (needs repo) | TBD | 📋 future | AI voice agent for contractors |
| **mw-sites** | rdmilly/mw-sites (needs repo) | VPS1+VPS2 | 🔄 next | All static sites |
